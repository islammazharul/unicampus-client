...
const Feedback = () => {
    return (
        <div className="flex flex-col max-w-xl mx-auto p-8 my-10 shadow-sm rounded-xl lg:p-12 bg-gray-900 text-gray-100">
            ...
            <div className="flex items-center justify-center">
                <a rel="noopener noreferrer" href="myCollege" className="text-sm text-gray-400">Maybe later</a>
            </div>
        </div>
    );
};
