...
const NavBar = () => {
    ...
    return (
        ...
        //             </svg> <span className='text-2xl'>UniCampus</span>
        //         </a>
        //         <div className={`flex items-center justify-self-center md:block md:pb-0 md:mt-0 ${navbar ? "block" : "hidden"
        //             }`}>
        ...
        //                 </li>
        //                 <li className="flex">
        //                     <a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 border-transparent">Colleges</a>
        //                 </li>
        //                 <li className="flex">
        //                     <a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 border-transparent">Admission</a>
        //                 </li>
        //                 <li className="flex">
        //                     <a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 border-transparent">My College</a>
        //                 </li>
        //             </ul>
        //         </div>
        ...
        //                     </button>
        //                 </span>
        //                 <input type="search" name="Search" placeholder="Search..." className="w-32 py-2 pl-10 text-sm rounded-md sm:w-auto focus:outline-none bg-gray-100 text-gray-800 focus:bg-gray-100" />
        //             </div>
        //             <a href="/login" type="button" className="hidden px-6 py-2 font-semibold rounded lg:block bg-violet-400 text-gray-900">Log in</a>
        //         </div>
        ...
        <nav className="p-4 w-full bg-gray-800 text-gray-100 shadow">
            <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
                ...
                <div>
                    ...
                    >
                        <div className="items-center justify-center space-y-4 md:flex md:space-x-3 md:space-y-0">
                            <ul className="items-center justify-center space-y-4 md:flex md:space-x-3 md:space-y-0">
                                ...
                                <li className="flex">
                                    <NavLink className={({ isActive }) => (isActive ? "active" : "default")} to="/allCollege">Colleges</NavLink>
                                </li>
                                <li className="flex">
                                    <NavLink className={({ isActive }) => (isActive ? "active" : "default")} to="/admission">Admission</NavLink>
                                </li>
                                <li className="flex">
                                    <NavLink className={({ isActive }) => (isActive ? "active" : "default")} to="/myCollege">My College</NavLink>
                                </li>
                            </ul>
                            <div className="relative">
                                <span className="absolute inset-y-0 left-0 flex items-center pl-2">
